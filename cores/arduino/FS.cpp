...
/* The ESP8266 core's FS_FREESTANDING_FUNCTIONS (global ::open()/mount())
   block is intentionally not ported: it referenced an FSImpl::mount()
   that does not exist in this core's FSImpl.h. */
